...
copy ..\..\..\..\bin\%ic_type%\usb\usb_headset.lib ..\..\..\..\bin\%ic_type%\usb.lib

if "%flash_bank_path%" == "1M" (
	copy ..\..\..\..\bin\%ic_type%\gap_lib\gap_utils_2M.lib ..\..\..\..\bin\%ic_type%\gap_utils.lib
...
if "%target%" == "" (
	...
	copy ..\..\..\..\bin\%ic_type%\framework\remote_%target%.lib ..\..\..\..\bin\%ic_type%\framework\remote.lib
)
