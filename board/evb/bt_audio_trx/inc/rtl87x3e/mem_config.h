...
#define APP_RAM_TEXT_SIZE           (10*1024 + 256)
#else
#define APP_RAM_TEXT_SIZE           (6*1024)
#endif

#if F_APP_CHARGE_CASE_DEMO_SUPPORT
#define APP_GLOBAL_BASE_SIZE       (16*1024)
#elif F_APP_BT_AUDIO_TRANSCEIVER_DEMO_SUPPORT
#define APP_GLOBAL_BASE_SIZE       (12*1024 + 512)
#else
#define APP_GLOBAL_BASE_SIZE       (12*1024)
#endif
#if CONFIG_REALTEK_FINDMY_FEATURE_SUPPORT
#define APP_FINDMY_SIZE            (11*1024)
#else
