...
/**
 * @brief GATT client pending packet number.
 */
typedef struct
{
    uint8_t write_cmd_num;
} T_GATT_CLIENT_PENDING_NUM;
 ...
 *  -    Others  Send general client callback event to application, such as @ref GATT_CLIENT_EVENT_DIS_ALL_STATE.
 ...
 *  -    Others  Check the specific characteristic CCCD.
 ...
 *  -    NULL    Send @ref GATT_CLIENT_EVENT_READ_RESULT through the callback function
                   registered by gatt_client_spec_register.
 *  -    Others  Send @ref GATT_CLIENT_EVENT_READ_RESULT through the callback function p_req_cb.
 * @return   Operation result.   @ref T_GAP_CAUSE.
 ...
 *  -    NULL    Send @ref GATT_CLIENT_EVENT_WRITE_RESULT through the callback function
                   registered by gatt_client_spec_register.
 *  -    Others  Send @ref GATT_CLIENT_EVENT_WRITE_RESULT through the callback function p_req_cb.
 * @return   Operation result.   @ref T_GAP_CAUSE.
...
/**
 * @brief    Set the Maximum pending packets in the Bluetooth GATT client module.
 * \xrefitem Experimental_Added_API_2_13_0_0 "Experimental Added Since 2.13.0.0" "Experimental Added API"
 * @param[in] num  Pending packet number @ref T_GATT_CLIENT_PENDING_NUM. The default number is 10.
 *
 * <b>Example usage</b>
 * \code{.c}
