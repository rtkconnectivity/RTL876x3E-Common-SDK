...
typedef enum
{
    ...
    BLE_EXT_ADV_STOP_CAUSE_DELETE_PENDING_START_ACTION,
    BLE_EXT_ADV_STOP_CAUSE_SYNC_ADV_STATE_WITH_STACK,
...
/**
 * @brief When irk changed, rpa shall be updated.
 *@note
 *\xrefitem Added_API_2_13_0_0 "Added Since 2.13.0.0" "Added API"
 */
...
/**
 * @brief ble_ext_adv_get_rpa_by_adv_handle
 * get rpa by adv handle
 *@note
 *\xrefitem Added_API_2_13_0_0 "Added Since 2.13.0.0" "Added API"
 * @param[in]  adv_handle  LE ADV handle, each ADV set has an ADV handle.
 * @param[out] p_random_addr  rpa find by adv handle.
 * @retval     true   return valid rpa
 * @retval     false  not find valid rpa
 */
