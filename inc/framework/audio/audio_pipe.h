 ...
 *
 * \param[in]   handle     Audio Pipe session handle \ref T_AUDIO_PIPE_HANDLE.
 * \param[in]   ratio      The ASRC ratio in ppm of the Audio Pipe session.
 *
 * \return          The result of setting the ASRC ratio.
 * \retval true     The ASRC ratio was set successfully.
 * \retval false    The ASRC ratio was failed to set.
 *
 * \ingroup AUDIO_PIPE
 */
