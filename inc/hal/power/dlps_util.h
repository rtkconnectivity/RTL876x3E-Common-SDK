 ...
 *
 * \param[out] wakeup_count: The bt mac low power mode wake up count.
 * \param[out] last_wakeup_clk: The bt mac last wake up clock.
 * \param[out] last_sleep_clk: The bt mac last sleep clock.
 *
 */
