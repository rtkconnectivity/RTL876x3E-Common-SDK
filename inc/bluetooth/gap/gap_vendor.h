...
typedef struct
{
    bool set_priority_flag; /**< Set priority flag. */
 ...
 *
 * @param[in]  bit_number
 * -    0  : Only be configured when scan is idle. Whether to optimize process about extended advertising report. Disabled by default.
 * -    1  : Only be configured when scan is idle. Whether to optimize process about legacy advertising report. Disabled by default.
 * @param[in]  bit_value
 * -    0  : Disable.
 * -    1  : Enable.
 *
