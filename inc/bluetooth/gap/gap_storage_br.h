 ...
 */
bool gap_br_get_bond(uint8_t *bd_addr,
                     uint8_t *link_key,
                     uint8_t *key_type);
 ...
 * \ingroup  GAP_BREDR_STORAGE
 */
bool gap_br_save_bond(uint8_t *bd_addr,
                      uint8_t *link_key,
                      uint8_t  key_type);
 ...
 * \ingroup  GAP_BREDR_STORAGE
 */
bool gap_br_get_paired_idx(uint8_t *bd_addr,
                           uint8_t *p_idx);
 ...
 * \ingroup  GAP_BREDR_STORAGE
 */
bool gap_br_set_bond_flag(uint8_t *bd_addr,
                          uint32_t bond_flag);
 ...
 * \ingroup  GAP_BREDR_STORAGE
 */
bool gap_br_get_bond_flag(uint8_t  *bd_addr,
                          uint32_t *bond_flag);
 ...
 * \ingroup  GAP_BREDR_STORAGE
 */
bool gap_br_get_addr_by_priority(uint8_t  priority,
                                 uint8_t *bd_addr);
