...
#define GAP_SC_KEY_CONVERT_BREDR_TO_LE_FLAG  0x02 //!< Link Key Conversion from BR/EDR to LE.
/**
  * @}
  */
...
#define GAP_MSG_VENDOR_CMD_CMPL_EVENT   0x03 //!< Vendor command complete event for mp test. The structure of callback data is @ref T_GAP_VND_CMD_CMPL_EVT_RSP
#define GAP_MSG_DUMP_TX_GAIN_IDX        0x04 //!< Response msg type for @ref gap_vendor_dump_tx_gain_idx. The structure of callback data is @ref T_GAP_DUMP_TX_GAIN_IDX_RSP.
...
#define GAP_MSG_GAP_READ_CONNECTION_ACCEPT_TIMEOUT             0x10 /**< Response msg type for @ref gap_read_connection_accept_timeout.
                                                                         The structure of callback data is @ref T_GAP_READ_CONNECTION_ACCEPT_TIMEOUT_RSP. */
#define GAP_MSG_GAP_WRITE_CONNECTION_ACCEPT_TIMEOUT            0x11 /**< Response msg type for @ref gap_write_connection_accept_timeout.
                                                                         The structure of callback data is @ref T_GAP_WRITE_CONNECTION_ACCEPT_TIMEOUT_RSP. */

#define GAP_MSG_GAP_CONFIGURE_DATA_PATH                        0x12 /**< Response msg type for @ref gap_configure_data_path.
                                                                         The structure of callback data is @ref T_GAP_CONFIGURE_DATA_PATH_RSP. */
#define GAP_MSG_GAP_READ_LOCAL_SUPPORTED_CODECS_V2             0x13 /**< Response msg type for @ref gap_read_local_supported_codecs_v2.
                                                                         The structure of callback data is @ref T_GAP_READ_LOCAL_SUPPORTED_CODECS_V2_RSP. */
#define GAP_MSG_GAP_READ_LOCAL_SUPPORTED_CODEC_CAPABILITIES    0x14 /**< Response msg type for @ref gap_read_local_supported_codec_capabilities.
                                                                         The structure of callback data is @ref T_GAP_READ_LOCAL_SUPPORTED_CODEC_CAPABILITIES_RSP. */
#define GAP_MSG_GAP_READ_LOCAL_SUPPORTED_CONTROLLER_DELAY      0x15 /**< Response msg type for @ref gap_read_local_supported_controller_delay.
                                                                         The structure of callback data is @ref T_GAP_READ_LOCAL_SUPPORTED_CONTROLLER_DELAY_RSP. */

#define GAP_MSG_VENDOR_CMD_RSP  0x16 //!< Response msg type for @ref gap_vendor_cmd_req. The structure of callback data is @ref T_GAP_VENDOR_CMD_RSP.
#define GAP_MSG_VENDOR_EVT_INFO 0x17 //!< Information for vendor-specific events. The structure of callback data is @ref T_GAP_VENDOR_EVT_INFO.

#define GAP_MSG_GATT_SERVER_SERVICE_CHANGE_INFO                0x20 //!< Information for GATT Server service change. The structure of callback data is @ref T_GATT_SERVER_SERVICE_CHANGE_CB.
/**
  * @}
  */
...
/** @brief LE Vendor event information. */
typedef struct
{
