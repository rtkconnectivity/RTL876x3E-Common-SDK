...
#define MAJOR_DEVICE_CLASS_WEARABLE               ((uint32_t)0x000700)
#define MAJOR_DEVICE_CLASS_TOY                    ((uint32_t)0x000800)
...
#define MINOR_DEVICE_CLASS_TABLET                 ((uint32_t)0x00001C)
...
#define MINOR_DEVICE_CLASS_PERIMULT_DIGITALPEN    ((uint32_t)0x00001C)
#define MINOR_DEVICE_CLASS_PERIMULT_SCANNER       ((uint32_t)0x000020)
#define MINOR_DEVICE_CLASS_PERIMULT_GESTURALINPUT ((uint32_t)0x000024)
...
/**
 * @defgroup    BT_WEARABLE_MINOR_CLASS       Bluetooth WEARABLE Minor Class
 * @brief       Bluetooth Minor device class definitions for major class WEARABLE.
 * @{
 */
#define MINOR_DEVICE_WEARABLE_WRISTWATCH          ((uint32_t)0x000004)
#define MINOR_DEVICE_WEARABLE_PAGER               ((uint32_t)0x000008)
#define MINOR_DEVICE_WEARABLE_JACKET              ((uint32_t)0x00000C)
#define MINOR_DEVICE_WEARABLE_HELMET              ((uint32_t)0x000010)
#define MINOR_DEVICE_WEARABLE_GLASSES             ((uint32_t)0x000014)
#define MINOR_DEVICE_WEARABLE_PIN                 ((uint32_t)0x000018)
/** End of BT_WEARABLE_MINOR_CLASS
 * @}
 */

/**
 * @defgroup    BT_TOY_MINOR_CLASS       Bluetooth TOY Minor Class
 * @brief       Bluetooth Minor device class definitions for major class TOY.
 * @{
 */
#define MINOR_DEVICE_TOY_ROBOT                    ((uint32_t)0x000004)
#define MINOR_DEVICE_TOY_VEHICLE                  ((uint32_t)0x000008)
#define MINOR_DEVICE_TOY_DOLLACTIONFIGURE         ((uint32_t)0x00000C)
#define MINOR_DEVICE_TOY_CONTROLLER               ((uint32_t)0x000010)
#define MINOR_DEVICE_TOY_GAME                     ((uint32_t)0x000014)
/** End of BT_TOY_MINOR_CLASS
 * @}
 */
...
/**
  ...
  * @{
  */
#define MINOR_DEVICE_HEALTH_BLOODPRESSURE         ((uint32_t)0x000004)
#define MINOR_DEVICE_HEALTH_THERMOMETER           ((uint32_t)0x000008)
#define MINOR_DEVICE_HEALTH_WEIGHINGSCALE         ((uint32_t)0x00000C)
#define MINOR_DEVICE_HEALTH_GLUCOSEMETER          ((uint32_t)0x000010)
#define MINOR_DEVICE_HEALTH_PULSEOXIMETER         ((uint32_t)0x000014)
#define MINOR_DEVICE_HEALTH_HEARTPULSERATE        ((uint32_t)0x000018)
#define MINOR_DEVICE_HEALTH_DATADISPLAY           ((uint32_t)0x00001C)
#define MINOR_DEVICE_HEALTH_STEPCOUNTER           ((uint32_t)0x000020)
#define MINOR_DEVICE_HEALTH_BODYCOMPOSITION       ((uint32_t)0x000024)
#define MINOR_DEVICE_HEALTH_PEAKFLOW              ((uint32_t)0x000028)
#define MINOR_DEVICE_HEALTH_MEDICATION            ((uint32_t)0x00002C)
#define MINOR_DEVICE_HEALTH_KNEEPROSTHESIS        ((uint32_t)0x000030)
#define MINOR_DEVICE_HEALTH_ANKLEPROSTHESIS       ((uint32_t)0x000034)
#define MINOR_DEVICE_HEALTH_GENERICHEALTHMANAGER  ((uint32_t)0x000038)
#define MINOR_DEVICE_HEALTH_PERSONALMOBILITY      ((uint32_t)0x00003C)
...
#define SERVICE_CLASS_LE_AUDIO                    ((uint32_t)0x004000)
#define SERVICE_CLASS_RESERVED                    ((uint32_t)0x008000)
...
#define SDP_CHARACTER_UTF8                  106     /**< UTF8 encoding. */
...
#define HCI_ERR_REJECT_LIMITED_RESOURCE         0x0D        /**< A connection or other request was rejected due to limited resources. */
#define HCI_ERR_REJECT_SECURITY_REASON          0x0E        /**< A connection or other request was rejected due to security requirements not being fulfilled, like authentication or pairing. */
#define HCI_ERR_REJECT_UNACCEPTABLE_ADDR        0x0F        /**< A connection or other request was rejected because this device does not accept the BD_ADDR. This may be because the device will only accept connections from specific BD_ADDRs. */
