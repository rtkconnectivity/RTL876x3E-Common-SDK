...
#define GATT_SERVER_SERVICE_CHANGE_STATE_BIT_SEND_INDICATION                         0 /**< Bit 0: Whether APP should send Service Changed Indication.
                                                                                            * - 0 : APP should not send Service Changed Indication.
                                                                                            * - 1 : APP should send Service Changed Indication. */
 ...
 *                  - cb_type is @ref GAP_MSG_GATT_SERVER_SERVICE_CHANGE_INFO, opcode is
 ...
 *                  - cb_type is @ref GAP_MSG_GATT_SERVER_SERVICE_CHANGE_INFO and opcode is
 ...
 *                  - cb_type is @ref GAP_MSG_GATT_SERVER_SERVICE_CHANGE_INFO and
