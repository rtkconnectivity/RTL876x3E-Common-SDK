...
/** @details
    Set @ref DIS_CHAR_MANUFACTURER_NAME_SUPPORT to 1 to support the Manufacturer Name String characteristic,
    otherwise set it to 0.
*/
#define DIS_CHAR_MANUFACTURER_NAME_SUPPORT          1

/** @details
    Set @ref DIS_CHAR_MODEL_NUMBER_SUPPORT to 1 to support the Model Number String characteristic,
    otherwise set it to 0.
*/
#define DIS_CHAR_MODEL_NUMBER_SUPPORT               1

/** @details
    Set @ref DIS_CHAR_SERIAL_NUMBER_SUPPORT to 1 to support the Serial Number String characteristic,
    otherwise set it to 0.
*/
#define DIS_CHAR_SERIAL_NUMBER_SUPPORT              1

/** @details
    Set @ref DIS_CHAR_FIRMWARE_REVISION_SUPPORT to 1 to support the Firmware Revision String characteristic,
    otherwise set it to 0.
*/
#define DIS_CHAR_FIRMWARE_REVISION_SUPPORT          1

/** @details
    Set @ref DIS_CHAR_HARDWARE_REVISION_SUPPORT to 1 to support Hardware Revision String characteristic,
    otherwise set it to 0.
*/
#define DIS_CHAR_HARDWARE_REVISION_SUPPORT          1

/** @details
    Set @ref DIS_CHAR_SOFTWARE_REVISION_SUPPORT to 1 to support Software Revision String characteristic,
    otherwise set it to 0.
*/
...
/** @details
    Set @ref DIS_CHAR_SYSTEM_ID_SUPPORT to 1 to support System ID characteristic,
    otherwise set it to 0.
*/
...
/** @details
    Set @ref DIS_CHAR_IEEE_CERTIF_DATA_LIST_SUPPORT to 1 to support IEEE 11073-20601 Regulatory Certification Data List characteristic,
    otherwise set it to 0.
*/
#define DIS_CHAR_IEEE_CERTIF_DATA_LIST_SUPPORT      1

/** @details
    Set @ref DIS_CHAR_PNP_ID_SUPPORT to 1 to support PnP ID characteristic,
    otherwise set it to 0.
*/
