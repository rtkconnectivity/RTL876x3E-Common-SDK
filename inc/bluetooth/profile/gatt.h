...
#define ATTRIB_FLAG_INCLUDE_MULTI  0x0040 /**< Attribute flag used to support multiple included services declared within a single primary service. 
When more than one include service declaration (type_value[0] in @ref T_ATTRIB_APPL is @ref LO_WORD (@ref GATT_UUID_INCLUDE),
type_value[1] in @ref T_ATTRIB_APPL is @ref HI_WORD (@ref GATT_UUID_INCLUDE)) is included within a single primary service,
each include service declaration needs to set this flag. */
