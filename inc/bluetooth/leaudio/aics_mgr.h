 ...
 * -    param_type @ref AICS_PARAM_INPUT_STATE, value_len is size of @ref T_AICS_INPUT_STATE.
 * -    param_type @ref AICS_PARAM_GAIN_SETTING_PROP, value_len is size of @ref T_AICS_GAIN_SETTING_PROP.
 * -    param_type @ref AICS_PARAM_INPUT_TYPE, value_len is uint8_t.
 * -    param_type @ref AICS_PARAM_INPUT_STATUS, value_len is uint8_t.
 * -    param_type @ref AICS_PARAM_INPUT_DES, value_len is the length of audio input description.
 * \param[in]  p_value             Pointer to the AICS parameter data.
 * \param[in]  set_change_counter  Whether to set change counter.
 * -    true    Set change counter when param_type is @ref AICS_PARAM_INPUT_STATE.
 * -    false   Not set change counter when param_type is @ref AICS_PARAM_INPUT_STATE.
 *
 ...
 * -     @ref AICS_PARAM_INPUT_STATE
 * -     @ref AICS_PARAM_GAIN_SETTING_PROP
 * -     @ref AICS_PARAM_INPUT_TYPE
 * -     @ref AICS_PARAM_INPUT_STATUS
