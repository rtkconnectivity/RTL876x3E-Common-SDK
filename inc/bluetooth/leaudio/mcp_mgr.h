...
{
    bool gmcs;                    /**<
                                       * -    true  : Generic Media Control Service (GMCS).
                                       * -    false : Media Control Service (MCS). */

    struct
    {
        bool support;             /**<
                                       * -    true  : Support characteristic.
                                       * -    false : Not support characteristic. */
        bool char_media_control_point_opcodes_supported_optional_property_notify; /**<
                                                                                       * -    true  : Support Notify property of Media Control Point Opcodes Supported characteristic.
                                                                                       * -    false : Not support Notify property of Media Control Point Opcodes Supported characteristic. */
    } char_media_control_point;   /**< Media Control Point characteristic. */

    struct
    {
        bool optional_property_notify; /**<
                                            * -    true  : Support Notify property.
                                            * -    false : Not support Notify property. */
...
{
    uint16_t     char_uuid;        /**<
                                      * -    @ref MCS_UUID_CHAR_MEDIA_STATE : Set parameter and send notification.
                                      * -    @ref MCS_UUID_CHAR_PLAYING_ORDERS_SUPPORTED : Set parameter.
                                      * -    @ref MCS_UUID_CHAR_MEDIA_CONTROL_POINT_OPCODES_SUPPORTED : Set parameter and send notification. */
...
{
    uint16_t     char_uuid;        /**<
                                      * -    @ref MCS_UUID_CHAR_MEDIA_PLAYER_NAME : Send notification.
                                      * -    @ref MCS_UUID_CHAR_TRACK_CHANGED : Send notification.
                                      * -    @ref MCS_UUID_CHAR_TRACK_TITLE : Send notification.
                                      * -    @ref MCS_UUID_CHAR_TRACK_DURATION : Send notification.
                                      * -    @ref MCS_UUID_CHAR_TRACK_POSITION : Send notification. */
    ...
    union
    {
        ...
        int32_t                              track_duration;       /**<
                                                                        ...
                                                                        * -    Zero or greater.
                                                                        * -    @ref MCS_TRACK_DURATION_CHAR_VALUE_UNKNOWN : No current
        ...
        int32_t                              track_position;       /**<
                                                                        ...
                                                                        * -    0: Starting position or start of the track is not well defined.
                                                                        * -    @ref MCS_TRACK_POSITION_CHAR_VALUE_UNAVAILABLE : No current
...
typedef struct
{
    ...
    uint8_t   service_id;
    uint16_t  char_uuid;         /**<
                                      * -    @ref MCS_UUID_CHAR_PLAYING_ORDERS_SUPPORTED
                                      * -    @ref MCS_UUID_CHAR_MEDIA_STATE
                                      * -    @ref MCS_UUID_CHAR_MEDIA_CONTROL_POINT_OPCODES_SUPPORTED
                                      *
                                      * -    @ref MCS_UUID_CHAR_MEDIA_PLAYER_NAME
                                      * -    @ref MCS_UUID_CHAR_TRACK_TITLE
                                      * -    @ref MCS_UUID_CHAR_TRACK_DURATION
                                      * -    @ref MCS_UUID_CHAR_TRACK_POSITION
                                      * -    @ref MCS_UUID_CHAR_CONTENT_CONTROL_ID */
 ...
 * - char_uuid of @ref T_MCP_SERVER_READ_IND is @ref MCS_UUID_CHAR_MEDIA_PLAYER_NAME , @ref MCS_UUID_CHAR_TRACK_TITLE ,
 * @ref MCS_UUID_CHAR_TRACK_DURATION , @ref MCS_UUID_CHAR_TRACK_POSITION , or @ref MCS_UUID_CHAR_CONTENT_CONTROL_ID
 * - return value of callback registered by @ref ble_audio_cback_register with msg @ref LE_AUDIO_MSG_MCP_SERVER_READ_IND
