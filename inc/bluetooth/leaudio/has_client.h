 ...
 * -    true  : The control point opcode is @ref HAS_CP_OP_SET_ACTIVE_PRESET_SYNC_LOCAL.
 * -    false : The control point opcode is @ref HAS_CP_OP_SET_ACTIVE_PRESET.
 *
 ...
 * \param[in]  conn_handle     Connection handle.
 * \param[in]  is_sync_local   Whether the opcode is sync locally.
 * -    true  : The control point opcode is @ref HAS_CP_OP_SET_NEXT_PRESET_SYNC_LOCAL.
 * -    false : The control point opcode is @ref HAS_CP_OP_SET_NEXT_PRESET.
 *
 ...
 * -    true  : The control point opcode is @ref HAS_CP_OP_SET_PREVIOUS_PRESET_SYNC_LOCAL.
 * -    false : The control point opcode is @ref HAS_CP_OP_SET_PREVIOUS_PRESET.
 *
