...
#define TBS_STATUS_FLAGS_CHAR_BIT_INBAND_RINGTONE                                  0  /**< Bit 0: Inband ringtone.
                                                                                           * - 0: Inband ringtone disabled.
                                                                                           * - 1: Inband ringtone enabled. */
#define TBS_STATUS_FLAGS_CHAR_BIT_SILENT_MODE                                      1  /**< Bit 1: Silent mode.
                                                                                           * - 0: Server is not in silent mode.
                                                                                           * - 1: Server is in silent mode. */
/**
...
#define TBS_CALL_CONTROL_POINT_OPTIONAL_OPCODES_CHAR_BIT_LOCAL_HOLD                0  /**< Bit 0: Local Hold.
                                                                                           * - 0: Local Hold and Local Retrieve Call Control Point Opcodes not supported.
                                                                                           * - 1: Local Hold and Local Retrieve Call Control Point Opcodes supported. */
#define TBS_CALL_CONTROL_POINT_OPTIONAL_OPCODES_CHAR_BIT_JOIN                      1  /**< Bit 1: Join.
                                                                                           * - 0: Join Call Control Point Opcode not supported.
                                                                                           * - 1: Join Call Control Point Opcode supported. */
/**
...
#define TBS_CALL_FLAGS_BIT_INCOMING_OUTGOING                                       0  /**< Bit 0: Incoming/Outgoing.
                                                                                           * - 0: Call is an incoming call.
                                                                                           * - 1: Call is an outgoing call. */
