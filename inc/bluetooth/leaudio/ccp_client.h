...
typedef struct
{
    uint8_t    *p_bearer_list_current_calls;         /**<
                                                          ...
                                                          * -    List_Item_Length[i] (1 octet) : Total length of the item, excluding the octet for the List_Item_Length field itself.
                                                          * -    Call_Index[i] (1 octet): A number chosen by Call Control Server to identify call.
                                                          * -    Call_State[i] (1 octet): @ref T_TBS_CALL_STATE.
                                                          * -    Call_Flags[i] (1 octet): A bit field, @ref TBS_CALL_FLAGS_BIT_Def.
                                                          * -    Call_URI[i] (variable): Incoming Call URI or Outgoing Call URI. */
    uint16_t    bearer_list_current_calls_len;       /**<
                                                          * -    0 : No calls are available.
                                                          * -    Other values. */
...
typedef struct
{
    uint8_t    *p_call_state;                        /**<
                                                          ...
                                                          * -    Call_Index[i] (1 octet): A number chosen by Call Control Server to identify call.
                                                          * -    State[i] (1 octet): @ref T_TBS_CALL_STATE.
                                                          * -    Call_Flags[i] (1 octet): A bit field, @ref TBS_CALL_FLAGS_BIT_Def. */
...
typedef struct
{
    ...
    bool        is_found;        /**<
                                      * -    true  : Service is found.
                                      * -    false : Service is not found. */
    bool        load_from_ftl;   /**<
                                      * -    true  : Service table is loaded from FTL.
                                      * -    false : Service table is not loaded from FTL. */
    bool        gtbs;            /**<
...
typedef struct
{
    ...
    uint16_t          char_uuid;       /**<
                                            ...
                                            * -    @ref TBS_UUID_CHAR_TERMINATION_REASON
