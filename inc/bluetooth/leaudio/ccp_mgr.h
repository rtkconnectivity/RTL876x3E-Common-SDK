...
{
    bool gtbs;                             /**<
                                                * -    true  : Generic Telephone Bearer Service (GTBS).
                                                * -    false : Telephone Bearer Service (TBS). */

    struct
    {
        bool optional_property_notify;     /**<
                                                * -    true  : Supports Notify property.
                                                * -    false : Does not support Notify property. */
    } char_bearer_uri_schemes_supported_list;

    struct
    {
        bool support;                      /**<
                                                * -    true  : Supports characteristic.
                                                * -    false : Does not support characteristic. */
...
{
    uint16_t     char_uuid;        /**<
                                        * -    @ref TBS_UUID_CHAR_CALL_CONTROL_POINT_OPTIONAL_OPCODES : Set parameter.
                                        * -    @ref TBS_UUID_CHAR_INCOMING_CALL_TARGET_BEARER_URI : Set parameter and send notification.
                                        * -    @ref TBS_UUID_CHAR_INCOMING_CALL : Set parameter.
                                        * -    @ref TBS_UUID_CHAR_CALL_FRIENDLY_NAME : Set parameter and send notification. */
...
typedef struct
{
    ...
    uint8_t     service_id;
    uint16_t    char_uuid;         /**<
                                        * -    @ref TBS_UUID_CHAR_BEARER_LIST_CURRENT_CALLS
                                        * -    @ref TBS_UUID_CHAR_INCOMING_CALL_TARGET_BEARER_URI
                                        * -    @ref TBS_UUID_CHAR_CALL_STATE
                                        * -    @ref TBS_UUID_CHAR_CALL_CONTROL_POINT_OPTIONAL_OPCODES
                                        * -    @ref TBS_UUID_CHAR_INCOMING_CALL
                                        * -    @ref TBS_UUID_CHAR_CALL_FRIENDLY_NAME
                                        *
                                        * -    @ref TBS_UUID_CHAR_BEARER_PROVIDER_NAME
                                        * -    @ref TBS_UUID_CHAR_BEARER_TECHNOLOGY
                                        * -    @ref TBS_UUID_CHAR_BEARER_URI_SCHEMES_SUPPORTED_LIST
                                        * -    @ref TBS_UUID_CHAR_BEARER_SIGNAL_STRENGTH
                                        * -    @ref TBS_UUID_CHAR_STATUS_FLAGS
                                        * -    @ref TBS_UUID_CHAR_BEARER_UCI
                                        * -    @ref TBS_UUID_CHAR_BEARER_SIGNAL_STRENGTH_REPORTING_INTERVAL
                                        * -    @ref TBS_UUID_CHAR_CONTENT_CONTROL_ID */
...
typedef struct
{
    ...
    union
    {
        ...
        uint8_t                                         bearer_signal_strength;                    /**<
                                                                                                        ...
                                                                                                        *
                                                                                                        * -    0 : No service.
                                                                                                        * -    1 to 99 : Meaning of the values is left up to the implementation.
                                                                                                        * -    100 : Maximum signal strength.
                                                                                                        * -    101 to 254: Reserved for future use.
                                                                                                        * -    255 : Signal strength is unavailable or has no meaning for this particular bearer. */
        ...
        uint8_t                                         bearer_signal_strength_reporting_interval; /**<
                                                                                                        ...
                                                                                                        *
                                                                                                        * -    0 : Signal strength is reported as soon as the signal strength changes.
                                                                                                        * -    1 to 255. */
 ...
 * - char_uuid of @ref T_CCP_SERVER_READ_IND is @ref TBS_UUID_CHAR_BEARER_PROVIDER_NAME , @ref TBS_UUID_CHAR_BEARER_TECHNOLOGY ,
 ...
 * - return value of callback registered by @ref ble_audio_cback_register with msg @ref LE_AUDIO_MSG_CCP_SERVER_READ_IND
