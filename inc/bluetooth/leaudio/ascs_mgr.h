 ...
 * -    true    Accept the CIS request.
 * -    false   Reject the CIS request.
 ...
 * -    true    Application controls the start/stop ready operation.
 * -    false   Application does not control the start/stop ready operation.
 *
