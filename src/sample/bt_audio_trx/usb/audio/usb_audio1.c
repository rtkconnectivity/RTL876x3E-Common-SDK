...
#if IAD_SUPPORT
static T_USB_INTERFACE_ASSOC_DESC uac1_iad_desc =
{
    ...
    .bInterfaceCount        = 2,
#endif
    .bFunctionClass = UAC1_CLASS_CODE_AUDIO,
    .bFunctionSubClass = UAC1_SUBCLASS_UNDEFINED,
    .bFunctionProtocol = 0,
    .iFunction = 0
};
#endif
...
static T_UAC1_STD_ISO_EP_DESC     out_ep_desc_hs =
{
    ...
    .wMaxPacketSize     = (UAC1_SPK_SAM_RATE_MAX / 1000) * (UAC1_SPK_BIT_RES / 8) * UAC1_SPK_CHAN_NUM,
    .bInterval          = 4,
    .bRefresh           = 0,
    .bSynchAddress      = 0,
};
...
static int usb_audio_deactivate(uint8_t dir)
{
    ...
    USB_AUDIO1_PIPE_CALLBACK(usb_audio1_pipe->ctrl, usb_audio1_pipe, evt, ctrl);
    APP_PRINT_TRACE1("usb_audio_deactivate, dir 0x%x", dir);
    return 0;
}
...
#if IAD_SUPPORT
    uac1_iad_desc.bFirstInterface = ac_interface_desc.bInterfaceNumber;
#endif
