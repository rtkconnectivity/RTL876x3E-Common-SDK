...
/** @defgroup  APP_OTA APP OTA handle
    * @brief APP OTA to implement OTA feature
    * @{
    */
/*============================================================================*
 *                              Macros
 *============================================================================*/
/** @defgroup APP_OTA_Exported_Macros App OTA service Exported Macros
    * @brief
    * @{
    */
...
#define MAX_IMG_NUM         (15 + 8) //bank image num + user data image num
...
#define TOTAL_TIME_OUT      ((OTA_BANK0_SIZE / 2048 + 1) * 240000)

#define UPDATE_FAIL         0
#define UPDATE_SUCCESS      1

#define FORCE_OTA_TEMP      0
/** End of APP_OTA_Exported_Macros
    * @}
    */
 ...
 *                              Types
 *============================================================================*/
/** @defgroup APP_OTA_Exported_Types APP OTA Exported Types
    * @brief
    * @{
    */
/** @brief  OTA mode */
...
typedef struct
{
    ...
    OTA_FLAG ota_flag;
    TEST_ENABLE test;
    T_OS_QUEUE cback_list[OTA_STAGE_MAX];
} T_APP_OTA_DB;
 ...
 *                              Functions
 *============================================================================*/
/** @defgroup APP_OTA_Exported_Functions APP OTA Functions
    * @brief
    * @{
    */
/**
...
/**
    * @brief    used to get inactive bank image address
    * @param    image_id image id
    * @return   inactive bank image address
    */
uint32_t app_trx_get_inactive_bank_addr(uint16_t image_id);

/**
    * @brief    used to get user data image address and size
    * @param    image_id image id
    * @param    img_info pointer to image address or size
    * @param    is_addr  ture: img_info is address; false: img_info is size
    * @return   T_USER_DATA_ERROR_TYPE
    */
T_USER_DATA_ERROR_TYPE dfu_get_user_data_info(USER_IMG_ID image_id, uint32_t *img_info,
                                              bool is_addr);
#else
...
/** @} */ /* End of group APP_OTA_Exported_Functions */

/** @} */ /* End of group APP_OTA */
#endif
