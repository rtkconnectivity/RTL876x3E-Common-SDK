...
typedef enum
{
    ...
    CMD_PATH_IAP  = 0x04,
    CMD_PATH_SPI  = 0x05,
    CMD_PATH_USB_HID  = 0x06,
    CMD_PATH_GATT_OVER_BREDR  = 0x07,
...
{
    EVENT_ACK                               = 0x0000,
    EVENT_REPLY_BR_PAIRED_RECORD            = 0x0001,
    EVENT_LEGACY_DATA_TRANSFER              = 0x0002,
    EVENT_PROFILE_CONN_STATUS               = 0x0003,
    EVENT_PROFILE_DISCONN_STATUS            = 0x0004,
    EVENT_HFP_CALLER_ID                     = 0x0005,
    EVENT_IAP_STATUS                        = 0x0006,
    EVENT_DEVICE_STATE                      = 0x0007,
    EVENT_REPLY_LINK_INFO                   = 0x0008,
    EVENT_REPLY_REMOTE_NAME                 = 0x0009,
    EVENT_HFP_CALL_STATUS                   = 0x000A,
    ...
    EVENT_REPORT_KEY_ACTION                 = 0x001D,
    EVENT_REPORT_HY_KEY_ACTION              = 0x001E,
...
//#endif
    ...
    EVENT_LE_USER_PASSKEY_INPUT_REQ         = 0x010C,

    EVENT_LE_BAS_INFO_REPORT                = 0x010B,

    EVENT_ANCS_REGISTER_COMPLETE            = 0x0110,
    EVENT_ANCS_NOTIFICATION                 = 0x0111,
    EVENT_ANCS_ACTION_RESULT                = 0x0112,
    EVENT_ANCS_NOTI_SRC_NOTIFY_EN           = 0x0113,
    EVENT_ANCS_DATA_SRC_NOTIFY_EN           = 0x0114,
    ...
    EVENT_AMS_READ_ENTITY_ATTR              = 0x0126,

    EVENT_LE_AUDIO_SCAN_INFO                = 0x0140,
    EVENT_LE_AUDIO_BAP_STATE                = 0x0141,
    EVENT_LE_AUDIO_BAP_DISCOVERY_DONE       = 0x0142,
    EVENT_LE_AUDIO_CSIS_SCAN_STATE          = 0x0143,
    EVENT_LE_AUDIO_ADD_GROUP                = 0x0144,
    EVENT_LE_AUDIO_ADD_SYNC_HANDLE          = 0x0145,
    EVENT_LE_AUDIO_BAAS_SCAN_INFO           = 0x0146,
    EVENT_LE_AUDIO_PA_SYNC_STATE            = 0x0147,
    EVENT_LE_AUDIO_CCP_CREATE_CALL          = 0x0148,

    EVENT_LE_ADV_CREATED                    = 0x0160,
...
//#endif
    ...
    EVENT_PLAYBACK_SET_SCENARIO             = 0x068F,
    ...
    EVENT_LINK_USER_PASSKEY_REQ             = 0x0912,
    EVENT_3IN1_DONGLE_CUSTOMIZED_REPORT     = 0x0A0E,
    ...
    EVENT_CCP_CALL_STATUS                   = 0x3252,
    EVENT_MCP_MEDIA_STATE                   = 0x3253,
    EVENT_VCS_STATE                         = 0x3256,
#endif
    ...
    EVENT_CHARGER_CASE_CONN_STATUS          = 0x8101,
    EVENT_CHARGER_CASE_SET_ADV              = 0x8102,
    EVENT_CHAGRER_CASE_REPORT_BT_ADDR       = 0x8103,
    EVENT_CHARGER_CASE_FIND_CHARGERBOX      = 0x8104,
    EVENT_CHARGER_CASE_INFO                 = 0x8107,
#endif

#if F_APP_BLE_HID_HOST_SUPPORT
    EVENT_BLE_HID_READ_REPORT_MAP           = 0x8200,
    EVENT_BLE_HID_READ_REPORT               = 0x8201,
    EVENT_BLE_HID_IN_REPORT                 = 0x8202,
#endif
...
#if F_APP_CHARGING_CASE_CMD_SUPPORT
/**
    * @brief  report charging case by spp/le/uart
    * @param  cmd_path br/le/uart
    * @param  cmd_id cmd id
    * @param  app_index BR/LE link index
    * @param  data cmd data
