...
#ifndef _APP_LEA_INI_BAP_BSRC_H_
#define _APP_LEA_INI_BAP_BSRC_H_
...
#if (BAP_BROADCAST_SOURCE || BAP_BROADCAST_ASSISTANT)
...
#define BSRC_STATE_IDLE                   0
#define BSRC_STATE_PLAY                   1
