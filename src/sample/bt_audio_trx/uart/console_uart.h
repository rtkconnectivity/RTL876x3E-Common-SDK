...
/** @defgroup T_CONSOLE_UART_EVENT
  * @brief T_CONSOLE_UART_EVENT
  * @{
  */
typedef enum
{
    CONSOLE_UART_EVENT_WAKE_UP,
    CONSOLE_UART_EVENT_DATA_IND,
...
typedef void (*P_CONSOLE_UART_CALLBACK)(T_CONSOLE_UART_EVENT evt, void *buf, uint16_t rx_count,
                                        uint8_t index);
