...
/**
 * @brief  Update the secondary bud when disable absolute volume
 * @param  gain the volume value.
 * @return void
 */
void app_lea_vol_sec_bud_update_streaming_track_vol(uint8_t gain);
