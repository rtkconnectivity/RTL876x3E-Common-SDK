...
typedef enum
{
    ...
    AUTO_POWER_OFF_MASK_RESERVED                            = 0x00020000,
    ...
    AUTO_POWER_OFF_MASK_VOICE                               = 0x00080000,
    AUTO_POWER_OFF_MASK_AUDIO                               = 0x00100000,
    AUTO_POWER_OFF_MASK_DATA_CAPTURE                        = 0x00200000,
