 ...
 *============================================================================*/
#ifndef _TRANS_UPDATEFILE_SERVICE_H_
#define _TRANS_UPDATEFILE_SERVICE_H_
...
#define BLE_TRANS_UPDATEFILE_MTU_SIZE   0x80
...
typedef union
{
    ...
    T_TRANS_UPDATEFILE_WRITE_MSG write;
} T_TRANS_UPDATEFILE_UPSTREAM_MSG_DATA;
...
#endif
    uint8_t                          conn_id;
    T_TRANS_UPDATEFILE_UPSTREAM_MSG_DATA     msg_data;
} T_TRANS_UPDATEFILE_CALLBACK_DATA;
...
#define  GATT_UUID128_TRANS_UPDATEFILE_SERVICE_ADV   0xF5, 0x17, 0x82, 0x91, 0x82, 0x67, 0x42, 0x6C, 0xBD, 0xA1, 0x70, 0x4A, 0xA9, 0x58, 0x4D, 0x49

/** @brief  Demo Profile service related UUIDs. */
#define GATT_UUID_CHAR_TRANS_UPDATEFILE_WRITE                          0xBA26
#define GATT_UUID_CHAR_TRANS_UPDATEFILE_NOTIFY                         0xBA27

/** @brief  Index of each characteristic in Demo Profile service database. */
#define BLE_SERVICE_CHAR_TRANS_UPDATEFILE_WRITE_INDEX                   0x02
#define BLE_SERVICE_CHAR_TRANS_UPDATEFILE_NOTIFY_INDEX                  0x04
#define BLE_SERVICE_CHAR_TRANS_UPDATEFILE_DATA_CCCD_INDEX               0x05 /**< @brief Index for Transmit Service tx chars's CCCD value */
...
/**
    ...
    * @return   void
    */
void trans_updatefile_service_send_notification(uint8_t conn_id, uint8_t *p_data,
                                                uint16_t data_len);
