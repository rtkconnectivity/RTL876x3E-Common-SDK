...
extern void *bt_hid_demo_io_queue_handle;
extern void *bt_hid_demo_evt_queue_handle;
...
bool app_io_send_msg(T_IO_MSG *io_msg)
{
    ...
    if (os_msg_send(bt_hid_demo_io_queue_handle, io_msg, 0) == true)
    {
        ret = os_msg_send(bt_hid_demo_evt_queue_handle, &event, 0);
    }
