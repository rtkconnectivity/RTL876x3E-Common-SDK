...
/** @defgroup COMMON_CFU Common CFU
    * @brief common cfu api
    * @{
    */
 ...
 *                         Macros
 *============================================================================*/
/** @defgroup COMMON_CFU_Exported_Macros Common CFU Exported Macros
    * @brief
    * @{
    */
...
/** End of COMMON_CFU_Exported_Macros
    * @}
    */
 ...
 *                              Types
 *============================================================================*/
/** @defgroup COMMON_CFU_Exported_Types Common CFU Exported Types
    * @brief
    * @{
    */
...
/** End of COMMON_CFU_Exported_Types
    * @}
    */
...
/** @defgroup COMMON_CFU_Exported_Functions Common CFU Exported Functions
    * @brief
    * @{
    */
...
/** @} */ /* End of group COMMON_CFU_Exported_Functions */
/** @} */ /* End of group COMMON_CFU */
