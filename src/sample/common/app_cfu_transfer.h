...
/** @defgroup CFU_TRANSFER APP CFU Transfer
 ...
 *                         Macros
 *============================================================================*/
/** @defgroup CFU_TRANSFER_Exported_Macros APP CFU Transfer Exported Macros
    * @brief
    * @{
    */
...
/** End of CFU_TRANSFER_Exported_Macros
    * @}
    */
 ...
 *                              Types
 *============================================================================*/
/** @defgroup CFU_TRANSFER_Exported_Types CFU Transfer Exported Types
    * @brief
    * @{
    */
...
/** End of CFU_TRANSFER_Exported_Types
    * @}
    */
...
/** @defgroup CFU_TRANSFER_Exported_Functions APP CFU Transfer Exported Functions
    * @brief
    * @{
    */
...
/** @} */ /* End of group CFU_TRANSFER_Exported_Functions */
/** @} */ /* End of group CFU_TRANSFER */
