...
/**
  * @brief  The function is to write all files in the Demo1 directory.
  * @param   No parameter.
  * @return  void
  */
void FatFS_DirectoyDemo(void)
{
    ...
    res = f_open(&fdst, (const TCHAR *)_T("0:/Demo1/test.txt"), FA_CREATE_ALWAYS | FA_WRITE);
    if (res != 0)
    {
