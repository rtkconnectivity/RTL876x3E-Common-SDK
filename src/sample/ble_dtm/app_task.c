...
{
    uint8_t event;
    os_msg_queue_create(&io_queue_handle, "dtm_queue", MAX_NUMBER_OF_IO_MESSAGE, sizeof(T_IO_MSG));
    os_msg_queue_create(&evt_queue_handle, "dtm_queue", MAX_NUMBER_OF_EVENT_MESSAGE, sizeof(uint8_t));
