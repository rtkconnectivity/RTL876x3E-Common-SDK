...
#ifndef _APP_BT5_CENTRAL_LINK_MANAGER_H_
#define _APP_BT5_CENTRAL_LINK_MANAGER_H_
/*============================================================================*
 *                              Header Files
 *============================================================================*/
...
/** @defgroup BT5_CENTRAL_LINK_MGR BT5 Central Link Mgr
    * @brief
    * @{
    */
/*============================================================================*
...
{
    uint8_t  bd_addr[GAP_BD_ADDR_LEN];/**< remote BD */
    bool     flag;/**< flag of recombining advertising data, true: recombining, false: waiting extended advertising PDUs */
...
/**
 * @brief link_mgr_clear_device_list
 *        Clear device list.
 * @retval void
 */
void link_mgr_clear_device_list(void);

/** @} */ /* End of group BT5_CENTRAL_LINK_MGR */
#endif
