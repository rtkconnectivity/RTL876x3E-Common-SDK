...
#include "app_bt5_peripheral_gap.h"
...
void app_peripheral_gap_handle_io_msg(T_IO_MSG io_msg)
{
    ...
    case IO_MSG_TYPE_BT_STATUS:
        {
            app_peripheral_gap_handle_gap_msg(&io_msg);
        }
        break;
    default:
        break;
    ...
    case GAP_CONN_STATE_CONNECTED:
        {
            ...
            APP_PRINT_INFO5("app_peripheral_gap_handle_conn_state_evt: GAP_CONN_STATE_CONNECTED remote_bd %s, remote_addr_type %d, conn_interval 0x%x, conn_latency 0x%x, conn_supervision_timeout 0x%x",
                                                     ...
                                                     uint16_t cause)
{
    ...
    case GAP_CONN_PARAM_UPDATE_STATUS_SUCCESS:
        {
            ...
            le_get_conn_param(GAP_PARAM_CONN_TIMEOUT, &conn_supervision_timeout, conn_id);
            APP_PRINT_INFO3("app_peripheral_gap_handle_conn_param_update_evt: update success conn_interval 0x%x, conn_slave_latency 0x%x, conn_supervision_timeout 0x%x",
    ...
    case GAP_CONN_PARAM_UPDATE_STATUS_FAIL:
        {
            APP_PRINT_ERROR1("app_peripheral_gap_handle_conn_param_update_evt: update failed cause 0x%x",
                             cause);
        }
        break;
    ...
    case GAP_CONN_PARAM_UPDATE_STATUS_PENDING:
        {
            APP_PRINT_INFO0("app_peripheral_gap_handle_conn_param_update_evt: update pending");
        }
        break;
...
/**
 * @brief app_peripheral_gap_handle_gap_msg
 *        All the BT GAP MSG are pre-handled in this function.
 * @note  Then the event handling function shall be called according to the sub_type of T_IO_MSG
...
void app_peripheral_gap_handle_gap_msg(T_IO_MSG *p_gap_msg)
{
    ...
    default:
        //APP_PRINT_ERROR1("app_peripheral_gap_handle_gap_msg: unknown subtype %d", p_gap_msg->subtype);
        break;
    }
}
...
T_APP_RESULT app_peripheral_gap_callback(uint8_t cb_type, void *p_cb_data)
{
    ...
    case GAP_MSG_LE_SCAN_REQ_RECEIVED_INFO:
        APP_PRINT_INFO3("app_peripheral_gap_callback: GAP_MSG_LE_SCAN_REQ_RECEIVED_INFO adv_handle %d, scanner_addr_type 0x%x, scanner_addr %s",
    ...
    case GAP_MSG_LE_AE_CODING_SCHEME:
        APP_PRINT_INFO1("app_peripheral_gap_callback: GAP_MSG_LE_AE_CODING_SCHEME cause 0x%x",
