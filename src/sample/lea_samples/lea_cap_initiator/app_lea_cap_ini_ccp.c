...
void app_lea_ini_ccp_send_input_msg(T_APP_TBS_INPUT_MSG msg, T_APP_TBS_INPUT_MSG_DATA *p_data)
{
    ...
    case APP_TBS_INPUT_MSG_CALL_INFO:
        {
            data_uart_print("APP_TBS_INPUT_MSG_CALL_INFO: call_index %d, call_flags 0x%2x\r\n",
                            p_data->call_info.call_index, p_data->call_info.call_flags);
    ...
    case APP_TBS_INPUT_MSG_CALL_TERMINATE:
        {
            data_uart_print("APP_TBS_INPUT_MSG_CALL_TERMINATE: call_index %d, reason_code %d\r\n",
    ...
    case LE_AUDIO_MSG_CCP_SERVER_READ_IND:
        {
            ...
            if (p_read_ind)
            {
                ...
                case TBS_UUID_CHAR_BEARER_PROVIDER_NAME:
                    {
                        read_cfm.param.bearer_provider_name.p_bearer_provider_name = "Provider name";
