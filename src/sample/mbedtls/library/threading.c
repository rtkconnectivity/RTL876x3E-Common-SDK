...
void (*mbedtls_mutex_init)(mbedtls_threading_mutex_t *) = mutex_init;
void (*mbedtls_mutex_free)(mbedtls_threading_mutex_t *) = mutex_free;
int (*mbedtls_mutex_lock)(mbedtls_threading_mutex_t *) = mutex_lock;
int (*mbedtls_mutex_unlock)(mbedtls_threading_mutex_t *) = mutex_unlock;
